...
// Auth Admin — Supabase Auth management surface (create/invite/delete auth users).
// Uses the same service_role key. Only available when Supabase is configured.
// Usage: supabaseAuthAdmin.createUser(...), supabaseAuthAdmin.generateLink(...)
export const supabaseAuthAdmin = supabaseAdmin.auth.admin

// Expose project URL for generating magic links etc.
